...
export function Productlist4() {
  ...
  return (
    <Container size="lg" py="xl">
      ...
      />
      <p>
      Pan feeders are designed to feed secondary stage or territory stage machines directly. They can be customized for your application to maximize performance and consistent operation. Our pan feeders can be widely utilized for example in aggregates production, mining operations, and recycling applications</p>
